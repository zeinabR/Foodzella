       ...
       <div class="about" id="about-section">
        ...
        <div class= "restaurantORrecipe"> 
            <div class="container">
                ...
                <a href="../RestCategories/cafe.php">
                    <img src="../images/drink1.jpg" class="small_images R2"></a>
                ...
                <a href="../RestCategories/Pizza.php">
                    <img src="../images/pizza1.jpg" class="small_images R5"></a>
                ...
                <div class="recipes">
                    ...
                    <a href="../RecipCategories/Dessert.php">
                        <img src="../images/dessert6.jpg" class="small_images C1"></a>
                    <a href="../RecipCategories/EasternFood.php">
                        <img src="../images/easternfood2.jpg" class="small_images C2"></a>
                    <a href="../RecipCategories/Drinks.php">
                        <img src="../images/drink2.jpg" class="small_images C3"></a>
                    <a href="../RecipCategories/FastFood.php">
                        <img src="../images/fastfood3.jpg" class="small_images C4"></a>
                    <a href="../RecipCategories/Diet.php">
                        <img src="../images/diet2.jpg" class="small_images C5"></a>
                    <a href="../RecipCategories/Syrian.php">
