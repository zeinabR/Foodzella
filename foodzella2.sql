...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2017 at 05:39 AM
...
(102, 'Fatta', 60, 11),
(103, 'Carrot Cake', 17, 8),
(104, 'Red vilvet', 17, 8),
(105, 'Cheese Cake', 18, 8),
(106, 'Om Ali', 20, 8),
(107, 'Chocolate Melt', 20, 8),
(108, 'Chicken Rapper Sandwich', 29, 30),
(109, 'Classic Angus ThickBurger Sandwich', 51, 30),
(110, 'Bacon Angus ThickBurger Sandwich', 55, 30),
(111, 'Jalapeno Chicken Sandwich', 42, 30),
(112, 'New Cordon Bleu Sandwich', 46, 30),
(113, 'Chilli Chilli', 46, 16),
(114, 'Cheese Lava', 46, 16),
(115, 'J poppers', 57, 16),
(116, 'crispy Fried Chicken', 57, 16),
(117, 'Big Willy', 80, 16),
(118, 'Shish Tawook Sandwich', 25, 12),
(119, 'Liver Sandwich', 25, 12),
(120, 'Hawawshi', 25, 12),
(121, 'Fatta', 21, 12),
(122, 'Hot dog  sandwitch', 25, 12),
(123, 'Super Maharja Meal', 55, 33),
(124, 'Chicken Sweet and Sour', 42, 33),
(125, 'Nasi Goreng', 45, 33),
(126, 'Seafood Meal', 68, 33),
(127, 'Noodles with Vegetables - Veg.', 16, 33),
(128, 'Kabab', 90, 17),
(129, 'Rice and Liver Dish', 40, 17),
(130, 'Mix Salad', 40, 17),
(131, 'shawerma', 40, 20),
(132, 'Fries', 35, 20),
(133, 'mix chicken', 20, 20),
(134, 'Nescafe', 20, 35),
(135, 'Capuuccino', 30, 35),
(136, 'Cafe latte Milkshake', 35, 35),
(137, 'Cafe latte Milkshake', 40, 36),
(138, 'Capuuccino', 35, 36),
(139, 'coffe', 40, 36),
(140, 'Mashroom Pizza', 200, 37),
(141, 'mix chicken', 300, 37),
(142, 'Pasta', 50, 37),
(143, 'Chocolate Melt', 27, 38),
(144, 'Nescafe', 26, 38),
(145, 'IceCream', 30, 38),
(146, 'fatta', 50, 39),
(147, 'shawerma', 40, 39),
(148, 'Fries', 35, 39),
(149, 'Pizza Syami', 100, 40),
(150, 'Mashroom Pizza', 150, 40),
(151, 'Cheese pizza', 150, 40);
...
(37, 'Martina Nader', 785449965, 'tinaNader@yahoo,com', '4512121212', 'Giza', 'elgalaa'),
(38, 'Karmn Nader', 784223444, 'KokyNader@yahoo.com', '4523656554', 'helwan', 'khesro'),
(39, 'Marina Walid', 12035468, 'RiryWalid@yahoo.com', '451254', 'Giza', 'Faisel'),
(40, 'Kerollos Walid', 54564654, 'koko2@yhakmk', '54513', 'Cairo', 'downTown'),
(41, 'George Hedra', 124879654, 'gogo@jhbjhbd.com', '5454', 'Aswan', 'Kom ombo');
...
INSERT INTO `recipe` (`Name`, `Recipe_ID`, `Admin_ID`, `Category`) VALUES
('Cheese Cake', 1, 1, 'Dessert'),
('Apple pie', 2, 2, 'Dessert'),
('Chocolate Cake', 3, 3, 'Dessert'),
('Fruit pizza', 4, 4, 'Dessert'),
('Magical Fruit Salad', 5, 1, 'Dessert'),
('Asian Beef and Noodles', 6, 2, 'Eastern Food'),
('shackshouka', 7, 3, 'Eastern Food'),
('Falafel', 8, 4, 'Eastern Food'),
('Kabab', 9, 1, 'Eastern Food'),
('Chicken Shawerma', 10, 1, 'Eastern Food'),
('Zalabia', 11, 2, 'Dessert'),
('Beef Shawerma', 12, 1, 'Eastern Food'),
('Tabbouleh', 13, 3, 'Syrian'),
('Baba Ghanoog', 14, 4, 'Syrian'),
('Shorbet Addas', 15, 2, 'Syrian'),
('Kibbe', 16, 3, 'Syrian'),
('Koussa Mehshi', 17, 4, 'Syrian'),
('Malfouf Mehshi', 18, 2, 'Syrian'),
('Beef Burger', 19, 3, 'Fast Food'),
('Chicken Burger', 20, 4, 'Fast Food'),
('Friskes Fries', 22, 2, 'Fast Food'),
('Shish Tawook', 23, 3, 'Fast Food'),
('Nugets', 24, 4, 'Fast Food'),
('Banana Berry Smothie', 25, 1, 'Drinks'),
('Fruit Cooler', 26, 2, 'Drinks'),
('Drinkable Yogurt', 27, 3, 'Drinks'),
('Oreo Milkshake', 28, 4, 'Drinks'),
('Cafe latte Milkshake', 29, 1, 'Drinks'),
('Iced Coffee', 30, 2, 'Drinks'),
('Honey Grapefruit with Banana', 31, 3, 'Diet'),
('Spiced Green Tea Smoothie', 32, 4, 'Diet'),
('Broccoli & Feta Omelet with Toast', 33, 1, 'Diet'),
('Chocolate-Dipped Banana Bites', 34, 2, 'Diet'),
('BBQ Turkey Burgers', 35, 3, 'Diet'),
('Middle Eastern Rice Salad', 36, 4, 'Diet'),
('Kofta', 37, 2, 'Fast Food');
...
('Eastern Food', 'Asian-Corner', 33, 123468579, '6th October', 'Elhossary', 5, 37, '12', 'Both', 8),
('Cafe', 'Al-Fishawy', 35, 754546696, 'cairo', 'Khan Elkhalily', 3, 20, '15', 'Both', 20),
('Cafe', 'Beano\'s', 36, 124579994, 'Zamalek', 'Omar Al Khayam', 3, 26, '8', 'Both', 26),
('Pizza', 'Pizza King', 37, 454564846, 'cairo', 'Dokki', 3, 38, '12', 'Both', 6),
('Cafe', 'Café Greco', 38, 1316464656, 'Al Maadi', 'Maadi Al Khabiri Ash Sharqeyah', 3, 39, '12', 'Table Reservation', 15),
('Syrian', 'Syrian Doner', 39, 235651, 'elmaadi', ' El Khamseen Street', 3, 40, '12', 'Both', 5),
('Pizza', 'Pizza Testy', 40, 54546464, 'Giza', 'Haram', 3, 41, '12', 'Both', 5);
...
--
ALTER TABLE `restaurant`
  MODIFY `Rest_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
