...
session_start();
    ...
    // page title
    $pageTitle = 'Syrian Food';

    // css files for this page
    $css_files = '<link rel="stylesheet" href="../css/RecipCategories/Syrian.css">';
    ...
    <div class="overlay">
        <div class="list-group" >';
                ...
                for($i=0 ; $i<$c1 ; $i++)
            {
                ...
                echo'
            <a href="../Restaurants/Syrian.php?cluster=' . $RequestText . ' " class="list-group-item " >
