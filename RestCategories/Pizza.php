...
session_start();
    ...
    $css_files = '<link rel="stylesheet" href="../css/RestCateg/Pizza.css">';
    ...
    <div class="overlay">
        <div class="list-group" >';
                ...
                for($i=0 ; $i<$c1 ; $i++)
            {
                ...
                echo'
            <a href="../Restaurants/Pizza.php?cluster=' . $RequestText . '" class="list-group-item " >
