...
session_start();
    ...
    // page title
    $pageTitle = 'Health Food';

    // css files for this page
    $css_files = '<link rel="stylesheet" href="../css/RestCateg/HealthFood.css">';
    ...
    $stmt ->execute(array('Healthy Food'));
    ...
    <div class="overlay">
        <div class="list-group" >';
                ...
                for($i=0 ; $i<$c1 ; $i++)
            {
                ...
                echo'
            <a href="../Restaurants/HealthFood.php?cluster=' . $RequestText . ' " class="list-group-item " >
